...
<body class="easyui-layout">
	<div data-options="region:'center'">
		<form id="recharge_form" action="/seed/recharge/add" method="post">
			<input type="hidden" name="classaccount_fid"
				value="${classaccount_fid}">
			<table>
				<tr>
					<th>充值:</th>
					<td><input type="text" id="times" name="times" value=""
						maxlength="4" size="4">(h)</td>
				</tr>
				<tr>
					<th>日期:</th>
