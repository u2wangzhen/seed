...
<tr>
<th>pdate:</th>
<td><input type="text" id="pdate" name="pdate" value="" maxlength="16" ></td>
</tr>
<tr>
<th>phour:</th>
<td><input type="text" id="phour" name="phour" value="" maxlength="4" ></td>
</tr>
<tr>
<th>startTime:</th>
<td><input type="text" id="startTime" name="startTime" value="" maxlength="24" ></td>
</tr>
<tr>
<th>endTime:</th>
<td><input type="text" id="endTime" name="endTime" value="" maxlength="24" ></td>
</tr>
<tr>
<th>remark:</th>
...
<tr>
	<th>lessons:</th>
	<td>
		<div id="lesson" class="selectOther"></div>
		<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true" onclick="openSelect('lesson');"></a>
	</td>
</tr>
<tr>
	<th>students:</th>
