		...
		if (key == 'lesson') {
			...
			$('#selectWindow').html(
					'<iframe id="select_iframe" src="/seed/' + key
							+ '/toSelect?student_fid=' + student_fid
							+ '" width="100%" height="100%"></iframe>');
		} else {
			$('#selectWindow')
					.html(
							'<iframe id="select_iframe" src="/seed/'
									+ key
...
<body class="easyui-layout">
	<div data-options="region:'center'">
		<form id="classaccount_form" action="/seed/classaccount/add"
			method="post">
			<table>
				<tr>
					<th>名称:</th>
