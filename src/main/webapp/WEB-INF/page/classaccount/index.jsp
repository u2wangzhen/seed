...
function openEdit(id){
	$("#classaccount_add_iframe").attr("src","/seed/classaccount/toEdit?id="+id);
	$('#dd').dialog({title:'编辑课时账户'});
	$('#dd').dialog('open');
}
...
function deleteOne(id){
	$.post('/seed/classaccount/delete',{'id':id},function(data){
...
<body>
<input type="text" id="name"  placeholder="名称" >&nbsp;&nbsp;<input type="text" id="student" placeholder="学生姓名">
    ...
    <thead>
		<tr>
			<th data-options="field:'id',width:50,sortable:true" >ID</th>
				...
				<th data-options="field:'lesson_s',sortable:true,formatter:viewFruit">课程</th>
